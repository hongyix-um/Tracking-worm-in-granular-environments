...
(3) A python-based code, utilizing an existing package (Bellybutton) to segment the particles in the same set of images.
(4) Example analysis code to utilize the above information.
